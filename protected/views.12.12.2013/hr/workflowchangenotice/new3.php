...
<?php $this->widget('bootstrap.widgets.TbTabs', array(
  ...
  'tabs'=>array(
      ...
      array(
        ...
        'content'=>'<div id="attachment-section">'.$this->renderPartial('_attachments',array('form'=>$form,'notice'=>$model,'type'=>$model->notice_type, 'subtype'=>$model->notice_sub_type),true).'</div>'.$tab2Buttons, 
