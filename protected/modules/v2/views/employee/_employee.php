	...
	<tbody>
		...
		<tr>
			...
			<td>
				...
				<p>$ <?php echo $payroll->rate_approved; ?> / <?php echo $payroll->rate_type;  ?> <br><small>(Effective <?php echo App::printDate($payroll->rate_effective_date);  ?>)</small></p>
			</td>
			<td>
