 ...
 * property or method in class "ReqItemsPurchaseTemp".
 *
 ...
 */
abstract class BaseReqItemsPurchaseTemp extends GxActiveRecord {
	...
	public static function label($n = 1) {
		return Yii::t('app', 'ReqItemsPurchaseTemp|ReqItemsPurchaseTemps', $n);
	}
	...
	public function rules() {
		return array(
			array('REQUISITION_idREQUISITION, item_num, quantity, unit, item_name, specification, price_estimate', 'required'),
