<div class="view">
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('is_seen')); ?>:</b>
	<?php echo CHtml::encode($data->is_seen); ?>
	<br />

	<b><?php echo CHtml::encode($data->getAttributeLabel('seen_datetime')); ?>:</b>
	<?php echo CHtml::encode($data->seen_datetime); ?>
	<br />
