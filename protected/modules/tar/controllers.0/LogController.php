...
class LogController extends Controller
{
	 ...
	 * Pure RESTful API
	 */
  public function actionIndex($id='',$html='0'){ //sleep(1);
    switch($_SERVER['REQUEST_METHOD']){
      case 'GET':
        if($html==='1'){
          $model = $this->loadModel($id);
          $this->renderPartial('/home/_home_tar_form',array('model'=>$model));
        }else{
          echo CJSON::encode($this->loadModel($id)->attributes);  
        }
      ...
      case 'POST':
        ...
        if(isset($_POST['TarLog']) and isset($_POST['ajax'])){
