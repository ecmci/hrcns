<form action="#" id="tar-form">
<div id="tar-form-preloader" style="display:none;"><img src="<?php echo Yii::app()->baseUrl; ?>/images/preloader.GIF"></div>
...
var reasons = ['Late Apply','Lost Docu Trail','Reasons','Another Reason','Yet Another Reason']; 
$('.typehead-close-reasons').typeahead({
  source : reasons,
  items : 10
});

$('#close-reason').on('change',function(){
  if($(this).val() == 'other'){
    $('#close-other-reason').show();
  }else{
    $('#close-other-reason').hide();
  }
});
...
<!-- Close Case Modal -->
<div id="modal-close-case" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button>
    <h3 id="myModalLabel">Reason for Closing</h3>
  </div>
  <div class="modal-body" style="height:200px;">
    <div class="control-group">
      <label class="control-label">Reason</label>
      <div class="controls">
<!--           <input class="span12 form-control typehead-close-reasons" type="text" data-provide="typeahead" autocomplete="off"> -->
        <select class="span12 form-control" id="close-reason">
          <option>-Select Reason-</option>
          <option>Late Apply</option>
          <option>Lost Docu Trail</option>
          <option>Reasons</option>
          <option>Another Reason</option>
          <option>Yet Another Reason</option>
          <option value="other">Other</option> 
        </select>
      </div>
      <div class="control-group" id="close-other-reason" style="display:none;">
      <label class="control-label">Specify Briefly in 1-2 Words</label>
      <div class="controls">
          <input class="span12 form-control" type="text">
      </div>
    </div>
    </div>  
  </div>
...
<!-- Follow Up Modal -->
<div id="modal-follow-up" class="modal hide fade" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-header">
    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button>
    <h3 id="myModalLabel">Log Activity and/or Follow Up</h3>
  </div>
  <div class="modal-body" style="height:350px;">    
    <div class="control-group">
      <label class="control-label">Activity or Message</label>
      <div class="controls">
    ...
    <div class="control-group">
      <label class="control-label">Notify via Email</label>
      <div class="controls">
    ...
    <div class="control-group">
      ...
      <div class="controls">
          <input class="span12 form-control" type="email">
      </div>
    </div>
    
  <div class="modal-footer">
    <button class="btn btn-mini" data-dismiss="modal" aria-hidden="true">Cancel</button>
    <button class="btn btn-primary">Log / Follow Up</button>
  </div>
  </div>
</div>
