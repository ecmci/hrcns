...
class TarLog extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('resident, admit_date, requested_dos_date_from, created_timestamp, approved_care_id, status_id, created_by_user_id, facility_id', 'required'),
			...
			array('control_num, resident, medical_num, type, reason_for_closing, resident_status', 'length', 'max'=>45),
			array('requested_dos_date_thru, applied_date, denied_deferred_date, approved_modified_date, backbill_date, notes', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('case_id, control_num, resident, medical_num, admit_date, type, requested_dos_date_from, requested_dos_date_thru, applied_date, denied_deferred_date, approved_modified_date, backbill_date, aging_amount, notes, is_closed, reason_for_closing, created_timestamp, approved_care_id, status_id, created_by_user_id, facility_id, resident_status', 'safe', 'on'=>'search'),
		);
	}
