 ...
 */
class Emailer extends CActiveRecord
{
	/**
	 * Returns the static model of the specified AR class.
	 * @param string $className active record class name.
	 * @return Emailer the static model class
	 */
	...
	public function search()
	{
		...
		$criteria->compare('t.sent_timestamp',$this->sent_timestamp,true);
		$criteria->compare('t.queued_timestamp',$this->queued_timestamp,true);
