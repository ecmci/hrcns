...
<?php $this->widget('bootstrap.widgets.TbGridView',array(
	...
	'columns'=>array(
		...
		array(
			'name'=>'profile_id',
			'type'=>'raw',
			'value'=>'NoticeView::profileLink("employee", $data->profile_id)',
		),
		
		array(
			'name'=>'personal_profile_id',
			'type'=>'raw',
			'value'=>'NoticeView::profileLink("personal", $data->personal_profile_id)',
		),
		
		array(
			'name'=>'employment_profile_id',
			'type'=>'raw',
			'value'=>'NoticeView::profileLink("employment", $data->employment_profile_id)',
		),
		
		array(
			'name'=>'payroll_profile_id',
			'type'=>'raw',
			'value'=>'NoticeView::profileLink("payroll", $data->payroll_profile_id)',
		),
		/*
		'initiated_by',		
		'summary_of_changes',
