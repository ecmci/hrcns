<div class="view">
	...
	<?php /*
	<b><?php echo CHtml::encode($data->getAttributeLabel('state_add')); ?>:</b>
	<?php echo CHtml::encode($data->state_add); ?>
	<br />
	...
	<b><?php echo CHtml::encode($data->getAttributeLabel('w4_status')); ?>:</b>
	<?php echo CHtml::encode($data->w4_status); ?>
	<br />
