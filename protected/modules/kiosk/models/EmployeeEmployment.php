...
class EmployeeEmployment extends CActiveRecord
{
  ...
  /**
	...
	public function rules()
	{
		...
		return array(
			array('facility_id, position_code', 'required'),
			...
			array('date_of_hire, date_of_termination, start_date, end_date, timestamp', 'safe'),
			// The following rule is used by search().
			// Please remove those attributes that should not be searched.
			array('id, emp_id, facility_id, status, date_of_hire, date_of_termination, department_code, position_code, start_date, end_date, contract_file, has_union, reports_to, is_approved, timestamp', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			...
			'departmentCode' => array(self::BELONGS_TO, 'HrDepartment', 'department_code'),
			'positionCode' => array(self::BELONGS_TO, 'HrPosition', 'position_code'),
	...
	public function attributeLabels()
	{
		return array(
			...
			'position_code' => 'Position To Apply',
