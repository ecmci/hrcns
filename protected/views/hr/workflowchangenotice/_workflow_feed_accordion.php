...
<div class="accordion" id="accordion2">
  <div class="accordion-group">
    ...
    <div id="collapseOne" class="accordion-body collapse <?php echo $notice->processing_group == 'BOM' ? 'in' : ''; ?>">
      <div class="accordion-inner">
        <?php if($notice->isSignable() and $notice->processing_group == 'BOM' and ($notice->notice_type == 'CHANGE' or $notice->notice_type == 'TERMINATED')){
			$this->widget('bootstrap.widgets.TbButton', array(
              'label'=>'Review and Submit',
              'type'=>'primary',
              'size'=>'large',
              'url'=>array('hr/workflowchangenotice/redo','id'=>$notice->id),
              'htmlOptions'=>array('data-dismiss'=>'modal'),
          ));
        }elseif($notice->isSignable() and $notice->processing_group == 'BOM'){
			$this->widget('bootstrap.widgets.TbButton', array(
              'label'=>'Review and Submit',
              'type'=>'primary',
              'size'=>'large',
  ...
  <div class="accordion-group">
    ...
    <div id="collapseTwo" class="accordion-body collapse <?php echo $notice->processing_group == 'FAC_ADM' ? 'in' : ''; ?>">
      <div class="accordion-inner">
  ...
  <div class="accordion-group">
    ...
    <div id="collapseThree" class="accordion-body collapse <?php echo $notice->processing_group == 'MNL' ? 'in' : ''; ?>">
      <div class="accordion-inner">
  ...
  <div class="accordion-group">
    ...
    <div id="collapseFour" class="accordion-body collapse <?php echo $notice->processing_group == 'CORP' ? 'in' : ''; ?>">
      <div class="accordion-inner">
      <?php if($notice->isSignable() and $notice->processing_group == 'CORP'){
        $this->widget('bootstrap.widgets.TbButton', array(
            ...
            'type'=>'primary',
            'size'=>'large',
            'url'=>array('hr/workflowchangenotice/finalize','id'=>$notice->id),
            'htmlOptions'=>array('data-dismiss'=>'modal'),
        ));    
      }else{
        $this->widget('bootstrap.widgets.TbDetailView',array(
