...
$docs = empty($notice->docs) ? unserialize($notice->attachments) : $notice->docs;
$docs = $docs == false ? array() : $docs;
//print_r($docs); exit();
...
<fieldset title="Attachments"><legend>Attachments</legend>
  <div class="attachments">
    ...
    <table class="table">
      <?php foreach($docs as $name=>$file){ ?>
      <tr>
        <th><?php //echo $doc->document; ?><span class="required">*</span></th>
        <td><?php echo $form->fileFieldRow($notice,"docs[$name]",array('value'=>$file, 'class'=>'span5','readonly'=>'readonly')) ?></td>
      </tr>      
      <?php } ?>
    </table>
  </div>
