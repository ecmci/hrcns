<?php
Yii::app()->clientScript->registerScript('auto-calc-percent-increase-ready',"
calcIncrease();
showReasonOther();
$('#".CHtml::activeId($model_payroll, 'rate_proposed')."').on('keyup',function(){
...
<?php echo $form->textFieldRow($model_payroll,'rate_approved',array('prepend'=>'$','hint'=>'To be finalized by HR','class'=>'span5','maxlength'=>10)); ?>
